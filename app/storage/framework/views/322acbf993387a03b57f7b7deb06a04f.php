<?php /** @var \Hyde\RealtimeCompiler\Http\DashboardController $dashboard */ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-dark bg-dark flex-md-nowrap p-2">
    <a class="navbar-brand col-md-3 col-lg-auto me-0 ps-3 fs-6" href="/dashboard" style="font-weight: 600;"><?php echo e($title); ?></a>
    <?php if(! $dashboard->isInteractive()): ?>
...
<main class="container py-4 mb-auto">
    <div class="col-xl-10 mx-auto">
        <header class="px-4 py-5 my-4 text-center bg-light">
            <h1 class="display-6 fw-bold"><?php echo e($title); ?></h1>
            <div class="mx-auto">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        <tr>
                            <?php $__currentLoopData = $dashboard->getProjectInformation(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td>
                                    <strong class="h6"><?php echo e($type); ?>:</strong>
                                    <span class="card-text"><?php echo e($info); ?></span>
                                    <?php if($loop->last): ?>
                                        ...
                                        <script>
                                            async function copyPathToClipboard() {
                                                let data = '<?php echo e(str_replace('\\', '\\\\', $info)); ?>';
                                                try {
    ...
    <section>
        <div class="col-xl-10 mx-auto">
            <div class="card mb-4">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="pageTypeSelection" name="pageTypeSelection" class="form-select" aria-label="Select page type">
                                                        ...
                                                        <?php $__currentLoopData = ['BladePage', 'MarkdownPage', 'MarkdownPost', 'DocumentationPage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e(str($page)->kebab()); ?>"><?php echo e($page); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="page-creation-group" id="createsPost" style="display: none">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="datetime-local" class="form-control" id="postDate" name="postDate" placeholder="Enter a post date (optional)" value="<?php echo e(date('Y-m-d H:i')); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="https://github.com/hydephp/realtime-compiler/issues/new?<?php echo e(http_build_query(['title' => 'Feedback on the dashboard create page modal', 'body' => 'Write something nice!'])); ?>" class="btn btn-sm btn-outline-success me-auto" title="This is a new feature, we'd love your feedback!" target="_blank" rel="noopener">Send feedback</a>
                ...
                <div class="card-body">
                    <?php if(empty($dashboard->getPageList())): ?>
                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tr>
                                    <?php $__currentLoopData = ['Page Type', 'Route Key', 'Source File', 'Output File', 'Identifier']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th><?php echo e($header); ?></th>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-end">Actions</th>
                                </tr>
                                <?php $__currentLoopData = $dashboard->getPageList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="pageRow-<?php echo e($route->getRouteKey()); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['page-table-row', $dashboard->getFlash('justCreatedPage') === $route->getRouteKey() ? 'justCreatedPage active' : '']); ?>">
                                        <td>
                                            <code title="\<?php echo e($route->getPageClass()); ?>"><?php echo e(class_basename($route->getPageClass())); ?></code>
                                        </td>
                                        <td>
                                            <?php echo e($route->getRouteKey()); ?>

                                        </td>
                                        <td>
                                            <?php echo e($route->getSourcePath()); ?>

                                        </td>
                                        <td>
                                            <?php echo e($route->getOutputPath()); ?>

                                        </td>
                                        <td>
                                            <?php echo e($route->getPageIdentifier()); ?>
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <?php if($dashboard->isInteractive()): ?>
                                                    <form class="buttonActionForm" action="" method="POST">
                                                        ...
                                                        <input type="hidden" name="routeKey" value="<?php echo e($route->getRouteKey()); ?>">
                                                        <button type="submit" class="btn btn-outline-primary btn-sm me-2" title="Open in system default application">Edit</button>
                                                    </form>
                                                <?php endif; ?>
                                                <a href="<?php echo e($route->getLink()); ?>" class="btn btn-outline-primary btn-sm" title="Open this page preview in browser">View</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section>
        <div class="col-xl-10 mx-auto">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <?php if(empty(\Hyde\Support\Filesystem\MediaFile::all())): ?>
                        <div class="alert alert-info">
                            <strong>Info:</strong>
                    ...
                    <?php else: ?>
                        <div class="container d-flex flex-wrap px-0">
                            <?php $__currentLoopData = \Hyde\Support\Filesystem\MediaFile::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mediaFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 p-2 d-flex flex-grow-1">
                                    <figure class="card w-100 p-2 mb-0">
                                        <?php if(in_array($mediaFile->getExtension(), ['svg', 'png', 'jpg', 'jpeg', 'gif', 'ico'])): ?>
                                            <img loading="lazy" src="media/<?php echo e($mediaFile->getIdentifier()); ?>" alt="<?php echo e($mediaFile->getName()); ?>" class="object-fit-cover w-100 rounded-2" style="height: 240px;">
                                        <?php else: ?>
                                            <code style="height: 240px; overflow: hidden; -webkit-mask-image: linear-gradient(180deg, white 60%, transparent);" role="presentation">
                                                <?php if($dashboard::isMediaFileProbablyMinified($mediaFile->getContents())): ?>
                                                    <pre style="white-space: normal;"><?php echo e($dashboard::highlightMediaLibraryCode($mediaFile->getContents())); ?></pre>
                                                <?php else: ?>
                                                    <pre class="overflow-hidden"><?php echo e($dashboard::highlightMediaLibraryCode($mediaFile->getContents())); ?></pre>
                                                <?php endif; ?>
                                            </code>
                                        <?php endif; ?>
                                        <figcaption class="container mt-3">
                                            <div class="row flex-nowrap">
                                                <div class="col-auto px-0">
                                                    <div class="file-icon" data-type="<?php echo e($mediaFile->getExtension()); ?>"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="row flex-nowrap justify-content-start">
                                                        <p class="col-auto text-truncate mb-0 pe-2" style="max-width: 210px;">
                                                            <strong title="<?php echo e($mediaFile->getPath()); ?>"><?php echo e($mediaFile->getName()); ?></strong>
                                                        </p>
                                                        <div class="col px-0 text-nowrap">
                                                            <small class="text-muted">(<?php echo e($dashboard::bytesToHuman($mediaFile->getContentLength())); ?>)</small>
                                                        </div>
                                                    </div>
                                                    <div class="row small align-items-center">
                                                        <div class="w-auto pe-0">
                                                            <a href="media/<?php echo e($mediaFile->getIdentifier()); ?>" title="Open this image in the browser" target="_blank">Fullscreen</a>
                                                        </div>
                                                        <?php if($dashboard->isInteractive()): ?>
                                                            <div class="w-auto ps-0">
                                                                <form class="buttonActionForm" action="" method="POST">
                                                                    ...
                                                                    <input type="hidden" name="identifier" value="<?php echo e($mediaFile->getIdentifier()); ?>">
    ...
    <?php if($dashboard->showTips()): ?>
        <section>
            <div class="col-xl-10 mx-auto pt-3 px-5">
                <div class="alert alert-success">
                    <strong>Tip:</strong>
                    <?php echo e($dashboard->getTip()); ?>
...
<footer class="bg-light text-center py-3 mt-3">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="col-lg-6">
            <p class="mb-1">
                HydePHP Realtime Compiler <span class="text-muted"><?php echo e($dashboard->getVersion()); ?></span>
            </p>
        </div>
        <div class="col-lg-3"></div>
    </div>
...
<?php if($dashboard->isInteractive()): ?>
    ...
    <script><?php echo $dashboard->getScripts(); ?></script>
...
<?php /**PATH /Users/danny/Projects/Personal/DannyvdSluijs.github.io/app/storage/framework/views/1d05954b4d24d7eba051508e488c4baa.blade.php ENDPATH**/ ?>